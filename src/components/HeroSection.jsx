  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4 text-white">
        <h2 className="text-4xl md:text-6xl font-bold mb-4 tracking-wide drop-shadow-md font-quincy">
          CURTAINS AND MORE
        </h2>
        <p className="text-base md:text-xl tracking-widest uppercase drop-shadow-md font-lovato">
